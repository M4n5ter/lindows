...
use crate::common::{
    codec::{base_bitrate, codec_thread_num, EncoderApi, EncoderCfg, Quality},
    EncodeInput, EncodeYuvFormat, Error, Pixfmt, Result, ResultType, STRIDE_ALIGN,
};
...
impl EncoderApi for VpxEncoder {
    ...
    fn yuvfmt(&self) -> crate::common::EncodeYuvFormat {
        self.yuvfmt.clone()
    }
