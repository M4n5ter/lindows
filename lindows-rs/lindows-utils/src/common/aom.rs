...
use crate::common::{
    codec::{base_bitrate, codec_thread_num, EncoderApi, Quality},
    EncodeFrame, EncodeInput, EncodeYuvFormat, Error, Pixfmt, Result, ResultType, STRIDE_ALIGN,
};
...
impl EncoderApi for AomEncoder {
    fn new(cfg: crate::common::codec::EncoderCfg, i444: bool) -> ResultType<Self>
    where
        Self: Sized,
    {
        match cfg {
            crate::common::codec::EncoderCfg::AOM(config) => {
