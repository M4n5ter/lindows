...
use crate::common::{EncodeYuvFormat, PixelBuffer, Pixfmt, ResultType, TraitPixelBuffer};
...
pub fn convert_to_yuv(
    ...
    if (src_pixfmt == Pixfmt::BGRA || src_pixfmt == Pixfmt::RGBA)
        && src.len() < src_stride[0] * src_height
    {
        bail!(
            "wrong src len, {} < {} * {}",
            src.len(),
    ...
    match (src_pixfmt, dst_fmt.pixfmt) {
        (Pixfmt::BGRA, Pixfmt::I420) | (Pixfmt::RGBA, Pixfmt::I420) => {
        ...
        (Pixfmt::BGRA, Pixfmt::I444) | (Pixfmt::RGBA, Pixfmt::I444) => {
            let dst_stride_y = dst_fmt.stride[0];
