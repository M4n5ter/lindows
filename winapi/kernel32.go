...
// GlobalFree 释放内存
//
// https://learn.microsoft.com/zh-cn/windows/win32/api/winbase/nf-winbase-globalfree
//
//	HGLOBAL GlobalFree(
//	    [in] _Frees_ptr_opt_ HGLOBAL hMem
//	);
func GlobalFree(hMem HGLOBAL) HGLOBAL {
	r1, _, _ := procGlobalFree.Call(uintptr(hMem))
	if r1 != 0 {
		return HGLOBAL(r1)
	}
	return 0
...
//
// https://learn.microsoft.com/zh-cn/windows/win32/api/winbase/nf-winbase-globallock
//
//	LPVOID GlobalLock(
//	    [in] HGLOBAL hMem
//	);
...
//
// https://learn.microsoft.com/zh-cn/windows/win32/api/winbase/nf-winbase-globalunlock
//
//	BOOL GlobalUnlock(
//	    [in] HGLOBAL hMem
//	);
